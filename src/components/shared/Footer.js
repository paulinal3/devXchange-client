                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/christos-miltiadou/" class="text-white">Linkedin</a>
                                </li>
                                <li>
                                    <a href="https://github.com/cmiltiadou" class="text-white">GitHub</a>
                                </li>
                                <li>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/galyverasi/" class="text-white">Linkedin</a>
                                </li>
                                <li>
                                    <a href="https://github.com/galyverasi" class="text-white">GitHub</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Portfolio</a>
                                </li>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/paulinal3/" class="text-white">Linkedin</a>
                                </li>
                                <li>
                                    <a href="https://github.com/paulinal3" class="text-white">GitHub</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Portfolio</a>
                                </li>
